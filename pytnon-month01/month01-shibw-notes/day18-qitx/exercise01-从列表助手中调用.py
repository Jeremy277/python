...
# 15:25 上课
#7.最小值
re = ListHelper.get_min(list01,lambda e:e.atk)
print(re.name)
#7.降序
ListHelper.order_by_down(list01,lambda e:e.duration)
for item in list01:
    print(item.name)
#8删除攻击力大于10的技能
print(ListHelper.del_data(list01,lambda item:item.atk < 9000))
for item in list01:
    print(item.atk)
